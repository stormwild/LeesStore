...
export class ApiServiceProxy {
    ...
    productFiles(fileName: string): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/ProductFiles/{filename}.xlsx";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processProductFiles(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processProductFiles(<any>response_);
                } catch (e) {
    ...
    protected processProductFiles(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
